...
// adjacency_list = {
//     "operating_system": [],
//     "computer_graphics": ["deep_learning_computer_vision"],
//     "deep_learning_computer_vision": [],
//     "algorithm": ["computer_graphics","operating_system"],
//     "data_structure": ["operating_system","computer_graphics"],
//     "machine_learning": ['deep_learning_computer_vision'],
//     "deep_learning_computer_vision": []
// }

// visited_list = {
//     "deep_learning_computer_vision": false,
...
// topology_sort = function(vertex) {
//     if ( visited_list[vertex] === false ) {
//         visited_list[vertex] = true
//         for (const neighbor in adjacency_list[vertex]) {
//             topology_sort(neighbor)
//         }
//         output_stack.push(vertex)
//     } 
// }

// for (const vertex in visited_list) {
